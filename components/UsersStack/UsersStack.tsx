...
import {IconPencil as Pencil, IconMessages as Messages, IconNote as Note, IconReportAnalytics as ReportAnalytics, IconTrash as Trash, IconDots as Dots} from '@tabler/icons';
